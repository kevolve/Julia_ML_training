...
A related legacy framework is [Weave.jl](https://github.com/JunoLab/Weave.jl).

## Integrations

You can also run Julia through Python and R via their language interfaces. We discuss this method later in this Unit.

# The Package Manager

Like most other modern langauges, Julia comes with a powerful package manager, allowing you to install various libraries and modules for different use cases.
...
The `sqrt` function computes square roots.
